package com.leo.leopicture.interfaces.controller;
...
import com.leo.leopicture.application.service.PictureApplicationService;
import com.leo.leopicture.application.service.SpaceApplicationService;
import com.leo.leopicture.application.service.UserApplicationService;
import com.leo.leopicture.domain.picture.entity.Picture;
import com.leo.leopicture.domain.picture.valueobject.PictureReviewStatusEnum;
import com.leo.leopicture.domain.space.entity.Space;
import com.leo.leopicture.domain.user.constant.UserConstant;
import com.leo.leopicture.domain.user.entity.User;
import com.leo.leopicture.infrastructure.annotation.AuthCheck;
import com.leo.leopicture.infrastructure.api.aliyunai.AliYunAiApi;
import com.leo.leopicture.infrastructure.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.leo.leopicture.infrastructure.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.leo.leopicture.infrastructure.api.imagesearch.ImageSearchApiFacade;
import com.leo.leopicture.infrastructure.api.imagesearch.model.ImageSearchResult;
import com.leo.leopicture.infrastructure.common.BaseResponse;
import com.leo.leopicture.infrastructure.common.DeleteRequest;
import com.leo.leopicture.infrastructure.common.ResultUtils;
import com.leo.leopicture.infrastructure.exception.BusinessException;
import com.leo.leopicture.infrastructure.exception.ErrorCode;
import com.leo.leopicture.infrastructure.exception.ThrowUtils;
import com.leo.leopicture.interfaces.assembler.PictureAssembler;
import com.leo.leopicture.interfaces.dto.picture.*;
import com.leo.leopicture.interfaces.vo.picture.PictureTagCategory;
import com.leo.leopicture.interfaces.vo.picture.PictureVO;
import com.leo.leopicture.shared.auth.SpaceUserAuthManager;
import com.leo.leopicture.shared.auth.StpKit;
import com.leo.leopicture.shared.auth.annotation.SaSpaceCheckPermission;
import com.leo.leopicture.shared.auth.model.SpaceUserPermissionConstant;
