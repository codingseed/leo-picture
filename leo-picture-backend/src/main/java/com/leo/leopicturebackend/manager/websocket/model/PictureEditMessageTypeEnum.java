package com.leo.leopicturebackend.manager.websocket.model;
...
public enum PictureEditMessageTypeEnum {
    ...
    GET_CURRENT_EDIT_STATUS("获取当前编辑状态", "GET_CURRENT_EDIT_STATUS"),
    CURRENT_EDIT_STATUS("当前编辑状态", "CURRENT_EDIT_STATUS");
